	...
	if(!$con){
		...
		while($row=mysqli_fetch_row($result)){
			...
			if($email_db == $email_f){
				...
				echo "<h3><center><a href='http://localhost/WEB%20Assignment/dashboard_settings.html'>Click here to redirect you to the <i>Call My Lawyer Settings Page</i></a></center></h3>";
				...
				echo "<h3><center><a href='http://localhost/WEB%20Assignment/dashboard_settings.html'>Click here to redirect you to the <i>Call My Laywer Settings Page</i></a></center></h3>";
